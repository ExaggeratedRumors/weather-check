...
class ForecastFragment: Fragment() {
    ...
    private fun updateData(dto: ForecastDTO) {
        ...
        day1.text = timestampToTime(dto.list[4].dt)
        val day2 = view.findViewById<TextView>(R.id.day_2)
        day2.text = timestampToTime(dto.list[12].dt)
        val day3 = view.findViewById<TextView>(R.id.day_3)
        day3.text = timestampToTime(dto.list[20].dt)
        val day4 = view.findViewById<TextView>(R.id.day_4)
        day4.text = timestampToTime(dto.list[28].dt)

        /** Temperatures **/
        val temperature1 = view.findViewById<TextView>(R.id.temperature_1)
        temperature1.text = setTemperature(dto.list[4].main.temp)
        val temperature2 = view.findViewById<TextView>(R.id.temperature_2)
        temperature2.text = setTemperature(dto.list[12].main.temp)
        val temperature3 = view.findViewById<TextView>(R.id.temperature_3)
        temperature3.text = setTemperature(dto.list[20].main.temp)
        val temperature4 = view.findViewById<TextView>(R.id.temperature_4)
        temperature4.text = setTemperature(dto.list[28].main.temp)

        /** Descriptions **/
        val weather1 = view.findViewById<TextView>(R.id.weather_1)
        weather1.text = setDescription(dto.list[4].weather[0].description)
        val weather2 = view.findViewById<TextView>(R.id.weather_2)
        weather2.text = setDescription(dto.list[12].weather[0].description)
        val weather3 = view.findViewById<TextView>(R.id.weather_3)
        weather3.text = setDescription(dto.list[20].weather[0].description)
        val weather4 = view.findViewById<TextView>(R.id.weather_4)
        weather4.text = setDescription(dto.list[28].weather[0].description)

        /** Icons **/
        val icon1 = view.findViewById<ImageView>(R.id.icon_1)
        icon1.setImageResource(chooseIcon(dto.list[4].weather[0].description))
        val icon2 = view.findViewById<ImageView>(R.id.icon_2)
        icon2.setImageResource(chooseIcon(dto.list[12].weather[0].description))
        val icon3 = view.findViewById<ImageView>(R.id.icon_3)
        icon3.setImageResource(chooseIcon(dto.list[20].weather[0].description))
        val icon4 = view.findViewById<ImageView>(R.id.icon_4)
        icon4.setImageResource(chooseIcon(dto.list[28].weather[0].description))
    }
}